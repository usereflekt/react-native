...
const ReflektProvider = ({ config, children, }) => {
    ...
    const [theme, setTheme] = (0, react_1.useState)(theme_1.DEFAULT_THEME);
    (0, react_1.useEffect)(() => {
        let isMounted = true;
        (async () => {
            try {
    ...
    const hideSurvey = (0, react_1.useCallback)(async (dismissed = true) => {
        setIsVisible(false);
    ...
    return (<ReflektContext.Provider value={contextValue}>
      <theme_1.ThemeProvider theme={theme}>
        {children}
...
//# sourceMappingURL=reflekt-provider.js.map