...
const SurveyPopup = ({ visible, onClose, children, length = 0, current = 0, }) => {
    ...
    const themedStyles = (0, react_1.useMemo)(() => react_native_1.StyleSheet.create({
        ...
        progressTrack: {
            ...
            height: 6,
            borderRadius: 2,
            backgroundColor: (0, theme_1.withOpacity)(theme.colors.primary, 0.08),
            overflow: 'hidden',
        },
        progressFill: {
            height: '100%',
        ...
        closeButton: {
            ...
            height: 24,
            borderRadius: 12,
            backgroundColor: (0, theme_1.withOpacity)(theme.colors.primary, 0.06),
            alignItems: 'center',
      ...
      <react_native_1.View style={styles.bottomContainer} pointerEvents="box-none">
        <react_native_gesture_handler_1.GestureDetector gesture={panGesture}>
          <react_native_1.TouchableWithoutFeedback onPress={react_native_1.Keyboard.dismiss}>
            <react_native_reanimated_1.default.View style={[themedStyles.sheet, sheetStyle]} onLayout={(event) => {
            sheetHeight.value = event.nativeEvent.layout.height;
        }}>
              <react_native_1.View style={styles.headerContainer}>
                <react_native_1.Text style={themedStyles.progressText}>
                  {current} of {length}
                </react_native_1.Text>
                <react_native_1.View style={themedStyles.progressTrack}>
                  <react_native_reanimated_1.default.View style={[themedStyles.progressFill, progressAnimatedStyle]}/>
                </react_native_1.View>
                <react_native_1.Pressable style={themedStyles.closeButton} onPress={onClose} hitSlop={12}>
                  <react_native_svg_1.default width={14} height={14} viewBox="0 0 12 12">
                    <react_native_svg_1.Path d="M3 3L9 9" stroke={theme.colors.textSecondary} strokeWidth={1.5} strokeLinecap="round"/>
                    <react_native_svg_1.Path d="M9 3L3 9" stroke={theme.colors.textSecondary} strokeWidth={1.5} strokeLinecap="round"/>
                  ...
                  <react_native_svg_1.default width="100%" height="100%">
                    <react_native_svg_1.Defs>
                      <react_native_svg_1.LinearGradient id="bottomWhiteFade" x1="0" y1="0" x2="0" y2="1">
                        <react_native_svg_1.Stop offset="0" stopColor={theme.colors.background} stopOpacity="0"/>
                        <react_native_svg_1.Stop offset="1" stopColor={theme.colors.background} stopOpacity="1"/>
...
//# sourceMappingURL=survey-modal.js.map